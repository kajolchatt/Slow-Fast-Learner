...
function Home(){
    ...
    const displayInfo=()=>{
        Axios.post('http://localhost:8000/home',{usn:usn,name:name,email:email,pno:pno,batch:batch,sem:sem,sem1:cgpa1,sem2:cgpa2,sem3:cgpa3,sem4:cgpa4,sem5:cgpa5,sem6:cgpa6,sem7:cgpa7,sem8:cgpa8,sub1:sub1,sub2:sub2,sub3:sub3,sub4:sub4,sub5:sub5,numberOfProjects:numberOfProjects,project1:project1,project2:project2,project3:project3,project4:project4,project5:project5}).then(()=>{
            console.log("Success");
        })
    }
    ...
    return (
        ...
        <label htmlFor="batch"><strong>Enter Batch</strong></label>
        <input type="text" id="batch" placeholder="Enter batch" onChange={(event)=>{setBatch(event.target.value);}}/><br />
        <label htmlFor="sem"><strong>Enter Current Semester</strong></label>
        <input type="sem" id="sem" placeholder="Enter Current Semester" onChange={(event)=>{setSem(event.target.value);}}/><br />
        
        <hr/>
        <h2>Project Information</h2><br></br>
        <label htmlFor="numberOfProjects"><strong>Enter number Of Projects</strong></label>
        <input type="text" id="numberOfProjects" placeholder="Enter no of projects done" onChange={(event)=>{setNumberOfProjects(event.target.value);}}/><br></br>
        <label htmlFor="project1"><strong>Enter 1'st Project Name</strong></label>
        <input type="text" id="project1" placeholder="Enter 1'st Project Name" onChange={(event)=>{setProject1(event.target.value);}}/><br></br>
        
        <label htmlFor="project2"><strong>Enter 2'nd Project Name</strong></label>
        <input type="text" id="project2" placeholder="Enter 2'nd Project Name" onChange={(event)=>{setProject2(event.target.value);}}/><br></br>
        
        <label htmlFor="project3"><strong>Enter 3'rd Project Name</strong></label>
        <input type="text" id="project3" placeholder="Enter 3'rd Project Name" onChange={(event)=>{setProject3(event.target.value);}}/><br></br>
        
        <label htmlFor="project4"><strong>Enter 4'th Project Name</strong></label>
        <input type="text" id="project4" placeholder="Enter 4'th Project Name" onChange={(event)=>{setProject4(event.target.value);}}/><br></br>
        
        <label htmlFor="project5"><strong>Enter 5'th Project Name</strong></label>
        <input type="text" id="project5" placeholder="Enter 5'th Project Name" onChange={(event)=>{setProject5(event.target.value);}}/><br></br>
...
<br></br>
        ...
        <label htmlFor="sub1"><strong>Subject 1</strong></label>
        <input type="text" id='sub1' placeholder="Enter Subject 1 marks" onChange={(event)=>{setSub1(event.target.value);}}/> <br /><br />
        <label htmlFor="sub2"><strong>Subject 2</strong></label>
        <input type="text" id="sub2" placeholder="Enter Subject 2 marks" onChange={(event)=>{setSub2(event.target.value);}}/> <br /><br />
        <label htmlFor="sub3"><strong>Subject 3</strong></label>
        <input type="text" id="sub3" placeholder="Enter Subject 3 marks" onChange={(event)=>{setSub3(event.target.value);}}/> <br /><br />
        <label htmlFor="sub4"><strong>Subject 4</strong></label>
        <input type="text" id="sub4" placeholder="Enter Subject 4 marks" onChange={(event)=>{setSub4(event.target.value);}}/> <br /><br />
        <label htmlFor="sub5"><strong>Subject 5</strong></label>
        <input type="text" id="sub5" placeholder="Enter Subject 5 marks" onChange={(event)=>{setSub5(event.target.value);}}/> <br /><br />
